...
*/
    ...
    override fun showRoomsOnMap(rooms: ArrayList<RoomPin>) {
        ...
        for (i in rooms.indices) {
            when {
                rooms[i].category?.get(0)?.categoryName.toString() == "" + getString(R.string.party) + "" -> mMap?.addMarker(
                    MarkerOptions()
                        .position(
                            LatLng(
                                rooms[i].latitude,
                ...
                rooms[i].category?.get(0)?.categoryName.toString() == "" + getString(R.string.business_events) + "" -> mMap?.addMarker(
                    MarkerOptions()
                        .position(
                            LatLng(
                                rooms[i].latitude,
                ...
                rooms[i].category?.get(0)?.categoryName.toString() == "" + getString(R.string.hobby_group) + "" -> mMap?.addMarker(
                    MarkerOptions()
                        .position(
                            LatLng(
                                rooms[i].latitude,
                ...
                rooms[i].category?.get(0)?.categoryName.toString() == "" + getString(R.string.cultural_activities) + "" -> mMap?.addMarker(
                    MarkerOptions()
                        .position(
                            LatLng(
                                rooms[i].latitude,
